...
const Products = () => {
  ...
  const sampleProducts = [
    {
      image: "/assets/features/cotton_casual_shirt.png",
    ...
    {
      image: "/assets/features/hp_pavilion_laptop.png",
    ...
    {
      image: "/assets/features/samsung_galaxy_s21.png",
    ...
    {
      image: "/assets/features/nike_running_shoes.png",
    ...
    {
      image: "/assets/features/fossil_analog_watch.png",
    ...
    {
      image: "/assets/features/philips_mixer_grinder.png",
    ...
    {
      image: "/assets/features/atomic_habits_book.png",
    ...
    {
      image: "/assets/features/wooden_study_table.png",
    ...
    {
      image: "/assets/features/boat_airdopes_441.png",
    ...
    {
      image: "/assets/features/vega_full_face_helmet.png",
        ...
        <section className="p-5">
          ...
          <ul className="py-4 select-none">
            {sidebarFilter.category.map((ele) => {
              return (
                <li key={ele.id} className="flex items-center font-semibold text-lg gap-2">
              ...
              <section key={idx} className=" p-4">
                <div className="shadow-lg rounded-lg overflow-hidden w-64">
                  <img
                    ...
                    alt="https://www.shutterstock.com/image-vector/no-image-available-picture-coming-600nw-2057829641.jpg"
